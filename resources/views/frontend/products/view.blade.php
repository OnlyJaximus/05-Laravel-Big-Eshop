...
<div class="py-3 mb-4 shadow-sm bg-warning border-top">
    <div class="container">
            ...
            <h6 class="mb-0"><a style="color: black" href="{{ url('/category') }}">Collections / </a>
            <a style="color: black" href="{{ url('/category/'.$products->category->name) }}">
            ...
            <div class="">
             ...
             <div class="row">
                ...
                <div class="col-md-8">
                                ...
                                <hr>
                                <label class="me-3">Original Price: <s>{{ $products->original_price }}</s> <small> RSD</small></label>
                                <label class="fw-bold">Selling Price: {{ $products->selling_price }} <small> RSD</small></label>
                         ...
                         <div class="row mt-2">
                               <div class="col-md-3">
                                    ...
                                    <label for="Quantity">Quantity</label>
                                      ...
                                      @else
                                      <input type="hidden" value="{{ $products->id }}" class="prod_id">
                                      <i class="bi bi-emoji-frown-fill mt-4" style="font-size:25px; color: red"></i>
                                      @endif
                                </div>
